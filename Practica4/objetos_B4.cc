...
void _plataforma::draw(_modo modo, float r, float g, float b, float grosor)
{
  ...
  else if (modo == 5 || modo == 6)
  {
    ...
    plataforma_base.draw_solido_suave();
  }
  else
  {
  ...
  else if (modo == 5 || modo == 6)
  {
    ...
    conecta_rueda.draw_solido_suave();
  }
  else
  {
  ...
  if (modo == 4)
  {
    plataforma_base.draw(modo, 1.0f, 0.0f, 0.0f, grosor);
  }
  else if (modo == 5 || modo == 6)
  {
    plataforma_base.ambiente_difuso = _vertex4f(0.61424f, 0.04136f, 0.04136f, 0.55f);
    plataforma_base.especular = _vertex4f(0.727811f, 0.626959f, 0.626959f, 0.55f);
    plataforma_base.brillo = 76.8f;
    plataforma_base.draw_solido_suave();
  }
  else
  {
...
void _scooter::draw(_modo modo, float r, float g, float b, float grosor)
{
  ...
  else if (modo == 5 || modo == 6)
  {
    ...
    conecta_rueda_minilla.draw_solido_suave();
  }
  else
  {
