...
_ejercicio3 ejercicio3;

int paso = 0, pulsar = 0, giro = 0, giro2 = 0;
...
void draw_objects()
{
    ...
    case SCOOTER:
        ...
        break;
    case EJERCICIO1:
        ejercicio1.draw(modo, 1.0, 0.0, 0.0, 5);
        break;
    case EJERCICIO2:
        ejercicio2.draw(modo, 1.0, 0.0, 0.0, 2);
        break;
    case EJERCICIO3:
        ejercicio3.draw(modo, 1.0, 0.0, 0.0, 2);
        break;
    }
}
